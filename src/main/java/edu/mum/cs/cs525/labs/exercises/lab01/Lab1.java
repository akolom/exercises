package edu.mum.cs.cs525.labs.exercises.lab01;
...
public class Lab1 extends javax.swing.JFrame
{
    ...
    private static final String IMAGES_PATH = "./src/main/resources/edu/mum/cs/cs525/labs/exercises/lab01/";
  ...
  protected EventListener makeCanvasListener(ScribbleCanvas canvas) {
    ...
    protected void addToolbarButtons(JToolBar toolBar) {
         ...
         clearb = new JButton(new ImageIcon(IMAGES_PATH + "clear.gif"));
         ...
         scribbleb = new JButton(new ImageIcon(IMAGES_PATH + "scribble.gif"));
         ...
         lineb = new JButton(new ImageIcon(IMAGES_PATH + "line.gif"));
         ...
         rectangleb = new JButton(new ImageIcon(IMAGES_PATH + "rectangle.gif"));
         ...
         ovalb = new JButton(new ImageIcon(IMAGES_PATH + "oval.gif"));
         ...
         eraseb = new JButton(new ImageIcon(IMAGES_PATH + "eraser.gif"));
